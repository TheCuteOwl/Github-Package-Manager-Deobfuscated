...
def GUI():
            ...
            for y in SDir1:
                if y in SDir:
                        ...
                        if fi == 0:
                            ...
                            def complexgather():
                                def set_values():
                                    ...
                                    values = [field1_value, field2_value, field3_value, field4_value, field5_value,
                                              field6_value]
                                ...
                                field4_label = tk.Label(root, text="Install Command 1")
                                field4 = tk.Entry(root, textvariable=field4_value)
                                field4_label.pack()
                                field4.pack()

                                field5_value = tk.StringVar()
                                field5_label = tk.Label(root, text="Install Command 2")
                                field5 = tk.Entry(root, textvariable=field5_value)
                                field5_label.pack()
                                field5.pack()

                                field6_value = tk.StringVar()
                                field6_label = tk.Label(root, text="Install Command 3")
                                field6 = tk.Entry(root, textvariable=field6_value)
                                field6_label.pack()
                                field6.pack()

                                submit_button = tk.Button(root, text="Set", command=set_values)
                                submit_button.pack()
                    ...
                    for item in item_list:
                        tk.Button(root, text=item, command=lambda i=item: button_click(i)).pack()
    ...
    def show_information():
        ...
        okay_button = tk.Button(info_window, text="Okay", command=info_window.destroy)
        okay_button.pack()
    ...
    def reset_all():
        ...
        Input = simpledialog.askstring("Password", "Enter your password:", show="*")
        ...
        try:
            ...
            try:
                ...
                open(f'{User.UserProfile.SourceDirectory}System/Cache/System/ErrorLog/Event.db', 'w')
    ...
    def Create():
        ...
        Input = simpledialog.askstring("Change Password", "ENTER NEW PASSWORD:", show="*")
        UUID = uuid.uuid1()
    ...
    def settings_window():
        ...
        def do_something(index):
            if index == 0:
                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            messagebox.showinfo("GHPM",'Wrong Password Entered')
                            pass
                ...
                messagebox.showinfo("GHPM", f'''To Launch The CLI, In your terminal all you need to do is run gh (arg)
...
======================================
    ...
    -UL -> Uninstall Local directories''')
                ...
                import os
                Name = simpledialog.askstring("GHPM", 'Enter Your Desired UserName: ')
                up = open(f'{os.getcwd()}/User/UserProfile.py', 'a')
                up.write(f"\nUsername = '{Name}'")
                up.close()
                ...
                Input = simpledialog.askstring("Change Password", "Enter your password:", show="*")
                try:
                    import System.Drive.Password as PS
        ...
        try:
            for i, option in enumerate(options):
                button = tk.Button(settings_win, text=option, command=lambda i=i: do_something(i))
                button.pack()
        except:
            pass
    ...
    def show_install():
        ...
        install_label = tk.Label(install_window, text="Enter a path to a local directory or a GitHub repository URL:")
        install_label.pack()

        install_entry = tk.Entry(install_window)
        install_entry.pack()

        choose_folder_button = ttk.Button(install_window, text="Choose folder", command=choose_folder)
        choose_folder_button.pack()

        install_submit = tk.Button(install_window, text="Submit",
    ...
    def confirm_uninstall(selected_item):
        ...
        result = tk.messagebox.askyesno("Confirm Uninstall",
        ...
        tk.messagebox.showinfo("Success", selected_item + " has been uninstalled.")
    ...
    def show_list_window():
        ...
        with open(f'{cwd}/System/Cache/System/GitHub/int.txt', 'r') as r, open(
                f'{cwd}/System/Cache/System/GitHub/int2.txt',
                'w') as o:
            for line in r:
                if line.strip():
                    o.write(line)
        ...
        confirm_button = tk.Button(list_window, text="Confirm Uninstall",
        ...
        if result1:
            ...
            if result2:
                ...
                with open(f'{cwd}System/Cache/System/Local/Int.txt', 'r') as r, open(
                        f'{cwd}System/Cache/System/Local/Int2.txt',
                        'w') as o:
                    for line in r:
                        if line.strip():
                            o.write(line)
                ...
                for option in options:
                    b = tkinter.Button(window, text=option, command=lambda opt=option: select_option(opt))
                    b.pack()
                ...
                if result3:
                    ...
                    with open(f'{cwd}/System/Cache/System/GitHub/Complex', 'r') as r, open(
                            f'{cwd}/System/Cache/System/GitHub/Complex2', 'w') as o:
                        for line in r:
                            if line.strip():
                                o.write(line)
                    ...
                    def select_option(selected_option):
                        ...
                        def submit():
                            ...
                            try:
                                os.system(f"osascript -e 'tell application \"Terminal\" to do script \"cd {B}&&{A}\"'")
                                #
                        ...
                        label_name = tk.Label(window2, text="Any Launch Arguments: ")
                        entry_name = tk.Entry(window2)

                        label_name.pack()
                        entry_name.pack()

                        button = tk.Button(window2, text="Submit", command=submit)
                        button.pack()
    ...
    def GH():
        ...
        with open(f'{cwd}System/Cache/System/GitHub/int.txt', 'r') as r, open(
                f'{cwd}System/Cache/System/GitHub/int2.txt', 'w') as o:
            for line in r:
                if line.strip():
                    o.write(line)
        ...
        def select_option(selected_option):
            ...
            try:
                ...
                try:
                    os.system(f"osascript -e 'tell application \"Terminal\" to do script \"cd {cc}&&{value4}\"'")
                except:
                    pass
    ...
    button = tk.Button(root, text="Information", bg="gray", height=2, width=10, command=show_information)
    button.grid(row=1, column=0, padx=10, pady=10)
    buttons.append(button)

    settings_button = tk.Button(root, text="Settings", bg="gray", height=2, width=10, command=settings_window)
    settings_button.grid(row=1, column=1, padx=10, pady=10)
    buttons.append(button)

    button = tk.Button(root, text="Install", bg="gray", height=2, width=10, command=show_install)
    button.grid(row=1, column=2, padx=10, pady=10)
    buttons.append(button)

    button = tk.Button(root, text="Activate", bg="gray", height=2, width=10, command=Activate)
    button.grid(row=2, column=0, padx=10, pady=10)
    buttons.append(button)

    button = tk.Button(root, text="Uninstall", bg="gray", height=2, width=10, command=show_list_window)
    button.grid(row=2, column=1, padx=10, pady=10)
    buttons.append(button)

    button = tk.Button(root, text="The Crypt", bg="gray", height=2, width=10, command=crypt)
    button.grid(row=2, column=2, padx=10, pady=10)
    buttons.append(button)

    button = tk.Button(root, text="EXIT", bg="red", height=2, width=10, command=exit_program)
...
def checkpoint():
    ...
    |++++++++|''')
        ...
        try:
            ...
            import System.Drive.Password as ps
            try:
                ps.Password(Event='FILE', Input=input('Enter password to use FileCache: '))
            except:
            ...
            if f == 2:
                import Password
                print(Password.main(message=None, password=User.UserProfile.Password, f=f, address=None))
                time.sleep(4)
            if f == 0:
                ...
                print(Password.main(message, password=Password, f=f, address=address))
            if f == 3:
            ...
            if f == 4:
                ...
                open(f'{User.UserProfile.SourceDirectory}System/Cache/User/{address}', 'w')
            elif f == 1:
                address = input('Name Of Storage: ')
                Input = input('Enter FileLock Password: ')
                key = input('Enter Key: ').encode()
                ...
                Password = hashed.hexdigest()
                import Password
                print(Password.main(message=None, password=Password, f=f, address=address))
...
'''
 ...
 ###Here the hidden script hidden into unsigned Char :
'''
global os
