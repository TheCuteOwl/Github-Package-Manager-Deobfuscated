...
if inp == '3':
    ...
    try:
        ...
        try:
            ...
            EV.NewEvent(event=f'Everything Failed To Reset Due To Password Error', Pol=0)
            raise exit(0)
...
if inp == '4':
    ...
    con = sl.connect(f'{User.UserProfile.SourceDirectory}System/Cache/System/ErrorLog/Event.db')
